      ...
      <section id="hero" className="relative overflow-hidden">
        ...
        <div className="hidden md:block relative min-h-screen">
          <div className="absolute inset-0 z-0">
            <img src="/assets/founders-Butfy_T2.jpeg"
            ...
            <div className="flex absolute z-20" style={{ bottom: "4rem", right: "15%", gap: "4rem", fontSize: "0.875rem" }}>
              <div className="text-center">
                <p className="font-display font-bold text-foreground">Natanael Almeida</p>
                <p className="text-primary text-xs tracking-widest uppercase">Co-fundador</p>
              </div>
              <div className="text-center">
                <p className="font-display font-bold text-foreground">Daniel Marques</p>
          ...
          <div className="relative z-10 max-w-7xl mx-auto w-full min-h-screen flex items-center px-12 py-20">
            <div style={{ maxWidth: "42rem" }}>
              <div className="mb-6">
                <img src="/assets/logo-ascensao-DQUHq5Wm.png" alt="Ascensão Company" className="h-52 lg:h-60 object-contain" />
              </div>
              ...
              <div className="mb-6 scroll-reveal">
                <button className="btn-cta glow-red">QUERO VENDER MAIS</button>
              </div>
        ...
        <div className="md:hidden flex flex-col min-h-screen">
          <div className="relative w-full pt-20">
            ...
            <div className="absolute flex justify-center text-xs z-10" style={{ bottom: "1rem", left: "0", right: "0", gap: "1.5rem" }}>
              <div className="text-center">
                <p className="font-display font-bold text-foreground">Natanael Almeida</p>
                <p className="text-primary uppercase tracking-widest" style={{ fontSize: "10px" }}>Co-fundador</p>
              </div>
              <div className="text-center">
                <p className="font-display font-bold text-foreground">Daniel Marques</p>
          ...
          <div className="relative z-10 px-6 pb-12 -mt-8 flex-1 flex flex-col justify-center">
            ...
            <div className="relative z-10">
              <div className="mb-4">
                <img src="/assets/logo-ascensao-DQUHq5Wm.png" alt="Ascensão Company" className="h-28 object-contain" />
              </div>
              ...
              <div className="mb-4 scroll-reveal">
                <button className="btn-cta glow-red text-base px-8 py-3">QUERO VENDER MAIS</button>
              </div>
              <div className="scroll-reveal">
